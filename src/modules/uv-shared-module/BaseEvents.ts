export class BaseEvents {
    ...
    static HIDE_ADJUST_DIALOGUE: string             = 'hideAdjustDialogue';
    ...
    static SHOW_ADJUST_DIALOGUE: string             = 'showAdjustDialogue';
    ...
    static ADJUST_CONTRAST: string                  = 'adjustContrast';
    static ADJUST_BRIGHTNESS: string                = 'adjustBrightness';
    static ADJUST_FINALIZE: string                  = 'adjustFinalize';
}